...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        'Ado\Spark\Events\Profile\ContactInformationUpdated' => [
            'Ado\Spark\Listeners\Profile\UpdateContactInformationOnStripe',
        ],

        'Ado\Spark\Events\PaymentMethod\VatIdUpdated' => [
            'Ado\Spark\Listeners\Subscription\UpdateTaxPercentageOnStripe',
        ],

        'Ado\Spark\Events\PaymentMethod\BillingAddressUpdated' => [
            'Ado\Spark\Listeners\Subscription\UpdateTaxPercentageOnStripe',
        ],

...
namespace Ado\Spark\Configuration;

use Closure;
use Illuminate\Support\Str;
use Ado\Spark\Contracts\Interactions\CheckPlanEligibility;
use Ado\Spark\Contracts\Interactions\CheckTeamPlanEligibility;

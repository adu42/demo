...
namespace Ado\Spark\Http\Controllers\Settings\Subscription;

use Ado\Spark\Spark;
use Illuminate\Http\Request;
use Ado\Spark\Http\Controllers\Controller;
use Ado\Spark\Contracts\Interactions\Subscribe;
use Ado\Spark\Events\Subscription\SubscriptionUpdated;
use Ado\Spark\Events\Subscription\SubscriptionCancelled;
use Ado\Spark\Http\Requests\Settings\Subscription\UpdateSubscriptionRequest;
use Ado\Spark\Contracts\Http\Requests\Settings\Subscription\CreateSubscriptionRequest;
...
class PlanController extends Controller
{
     ...
     *
     * @param  \Ado\Spark\Http\Requests\Settings\Subscription\UpdateSubscriptionRequest  $request
     * @return Response
     */

...
use Ado\Spark\Notification;
use Ado\Spark\Events\NotificationCreated;
use Ado\Spark\Contracts\Repositories\NotificationRepository as NotificationRepositoryContract;
